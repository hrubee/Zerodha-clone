...
export default async function handler(req, res) {
  ...
  try {
    ...
    const symbols = [
      { key: 'nifty', sym: '%5ENSEI', name: 'NIFTY 50', fallbackPrice: 23118.60, fallbackPrev: 23398.10 },
      { key: 'sensex', sym: '%5EBSESN', name: 'SENSEX', fallbackPrice: 74003.82, fallbackPrev: 74781.76 },
      { key: 'banknifty', sym: '%5ENSEBANK', name: 'NIFTY BANK', fallbackPrice: 55794.75, fallbackPrev: 56606.55 }
    ];
    ...
    await Promise.all(
      symbols.map(async (item) => {
        ...
        // Fallback realistic prices (Change vs Prev Close)
